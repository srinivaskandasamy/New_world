...
#                 D_x =   D.get('X')
#                 D_y =   D.get('Y')  
                if self.raddress == '68:86:E7:00:CA:82':
                        print "alpha is up"
#                         for i in range(10):
#                             print D_x[4*i,0], D_y[4*i,0]
                        self.set_control(100,100)
                        print "alpha has completed"
                if self.raddress == '68:86:E7:00:40:C2':
                        print "bravo is up"
#                         for i in range(10):
#                             print D_x[4*i,1], D_y[4*i,1]
                        self.set_control(100,100)
                        print "bravo has completed"
                if self.raddress == '68:86:E7:00:51:65':
                        print "charlie is up"
#                         for i in range(10):
#                             print D_x[4*i,1], D_y[4*i,1]
                        self.set_control(0,100)
                        print "charlie has completed"
                
                if self.raddress == '68:86:E7:00:2C:EB':
                        print "ddd"
                        self.set_control(-100,100)
                        print "ddd has completed"        
                if self.raddress == '68:86:E7:01:2C:FB':
                        print "eee is up"
                        self.set_control(-100,0)
                        print "eee has completed" 
                if self.raddress == '68:86:E7:00:56:7D':
                        print "fff is up"
                        self.set_control(0,-100)
                        print "fff has completed"
...
#     bravo = SpheroNode(2,"bravo",[0, 255, 0])
#     charlie = SpheroNode(3,"charlie",[0, 0, 255])    
#     ddd = SpheroNode(4,"ddd",[255, 0, 255])
#     eee = SpheroNode(5,"eee",[255, 255, 0])
#     fff = SpheroNode(6,"fff",[0, 255, 255])
